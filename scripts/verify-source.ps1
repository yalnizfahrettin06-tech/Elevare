...
Assert-Check ($allSource -match 'fun sessionResumeBlockReason') 'Saved sessions share safety review'
Assert-Check ($allSource -match 'elapsedRealtimeDeadline') 'Monotonic runtime clock'
Assert-Check ($allSource -match 'class StateCodec|object StateCodec') 'Versioned recovery-safe storage'

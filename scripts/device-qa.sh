...
for evidence in 07-home.png 11-player.png 15-restored-paused.png 17-font-200.png 18-routines.png 19-routine-detail.png 20-lifestyle-home.png 21-pro-confirm.png 22-pro-applied.png 23-player-large-text.png running-normal.mp4 running-slow.mp4 yoga-entry-hold-exit.mp4; do
